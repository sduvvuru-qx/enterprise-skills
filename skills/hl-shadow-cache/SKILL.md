---
name: Headless SHADOW Cache
description: 'Use when the user needs: Headless .shadow cache verifier and promoter for SHADOW. Use this to verify that a config or conversations cache is promotable, or to run a dry-run or explicit apply promotion into the current machine''s home directory.'
icon: icon.svg
metadata:
  install_kind: shim
  promoted_from: /Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/packages/headless-shadow-cache/SKILL.md
  source_cluster: shadow-headless
  requires_mount: /Volumes/SHADOW
  category: automation/headless
  family: hl
  lifecycle: active
  canonical_slug: hl-shadow-cache
  icon_style: craft-category-glyph-v1
---

# headless-shadow-cache

Installed shim for the project-local SHADOW skill.

Canonical source:
- `/Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/packages/headless-shadow-cache/SKILL.md`

Local wrapper:
- `/Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/bin/headless-shadow-cache`
