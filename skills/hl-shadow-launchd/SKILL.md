---
name: Headless SHADOW Launchd
description: 'Use when the user needs: Headless .shadow launchd installer for SHADOW. Use this to install the source-host launch agents that schedule the config and conversation cycles on macOS, and to document the current :05 and :20 schedule expectations.'
icon: icon.svg
metadata:
  install_kind: shim
  promoted_from: /Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/packages/headless-shadow-launchd/SKILL.md
  source_cluster: shadow-headless
  requires_mount: /Volumes/SHADOW
  category: automation/headless
  family: hl
  lifecycle: active
  canonical_slug: hl-shadow-launchd
  icon_style: craft-category-glyph-v1
---

# headless-shadow-launchd

Installed shim for the project-local SHADOW skill.

Canonical source:
- `/Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/packages/headless-shadow-launchd/SKILL.md`

Local wrapper:
- `/Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/bin/headless-shadow-launchd`
