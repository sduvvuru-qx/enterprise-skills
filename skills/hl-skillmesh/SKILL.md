---
name: 'Headless SkillMesh'
description: 'Use when the user needs: Headless mesh skill inventory and pooling helper for SHADOW. Use this to discover `SKILL.md` trees across reachable mesh peers, write managed reports under `./ShadowArchive/80-reports`, and mirror selected remote skills into `./ShadowArchive/10-projects/headless-skills/imported/mesh` without manually copying files host by host.'
icon: icon.svg
metadata:
  install_kind: shim
  promoted_from: /Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/packages/headless-skillmesh/SKILL.md
  source_cluster: shadow-headless
  requires_mount: /Volumes/SHADOW
  category: automation/headless
  family: hl
  lifecycle: active
  canonical_slug: hl-skillmesh
...
Canonical source:
- `/Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/packages/headless-skillmesh/SKILL.md`

Local wrapper:
- `/Volumes/SHADOW/ShadowArchive/10-projects/headless-skills/bin/headless-skillmesh`
